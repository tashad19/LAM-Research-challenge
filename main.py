...
class ContourApp:
    ...
    def process_image(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Invalid offset or smoothing factor.")
            return
        ...
        self.contour = smooth_contour(offset_cont, smoothing_factor)
...
def smooth_contour(contour, smoothing_factor):
    return cv2.approxPolyDP(contour, smoothing_factor * cv2.arcLength(contour, True), True)
